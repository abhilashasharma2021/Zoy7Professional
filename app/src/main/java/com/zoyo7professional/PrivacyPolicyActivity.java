...
import static com.zoyo7professional.ApiData.API.privacyPolicy;
...
import com.zoyo7professional.activity.TermAndConditionActivity;
import com.zoyo7professional.databinding.ActivityPrivacyPolicyBinding;
                    ...
                    if (object.has("result")) {
                        ...
                        if (result.equals("true")) {
                            ...
                            for (int j = 0; j <jsonArray.length() ; j++) {
                                ...
                                binding.text.setText(Html.fromHtml(Html.fromHtml(jsonObject.getString("privacy_policy")).toString()));
                            ...
                            Toast.makeText(PrivacyPolicyActivity.this, object.getString("message"), Toast.LENGTH_SHORT).show();
                            binding.progressBar.setVisibility(View.GONE);
                        }
                    }
